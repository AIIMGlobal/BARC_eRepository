...
<html lang="en">
    <head>
        ...
        <title>Content Submission Mail</title>
                ...
                <td align="center" style="padding: 20px 0;">
                    <div class="email-container">
                        ...
                        <div class="content-section">
                            <p class="greeting">Hello {{ $admin->name_en ?? 'Admin' }},</p>
                            <p class="content-message">A new content has been uploaded by {{ $content->createdby->name_en ?? 'User' }}.</p>
                        </div>
