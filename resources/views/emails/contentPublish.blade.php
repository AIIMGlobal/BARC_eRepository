...
xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
        ...
        <title>Content Publish Mail</title>
                                                            ...
                                                            <td style="overflow-wrap:break-word;word-break:break-word;padding:40px 40px 30px;font-family:'Lato',sans-serif;" align="left">
                                                                <div style="color: #000000; line-height: 140%; text-align: left; word-wrap: break-word;">
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 18px; line-height: 25.2px; color: #666666;">Hello {{ $content->createdBy->name_en ?? '' }}, </span>
                                                                    </p>
                                                                    ...
                                                                    <p style="font-size: 14px; line-height: 140%;">
                                                                        <span style="font-size: 14px; line-height: 25.2px; color: #000;">Congratulations! Your content has been published.</span>
                                                                    </p>
                                                                </div>
                                                            </td>
                                                        </tr>
