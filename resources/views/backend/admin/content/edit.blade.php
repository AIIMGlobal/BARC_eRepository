            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <div class="card card-height-100">
                        ...
                        <div class="card-body">
                            <form id="editForm" action="{{ route('admin.content.update', $content->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        <label for="content" class="form-label fw-bold">Content File:</label>
                                        <input type="file" class="form-control" id="content" name="content">
                                        @if($content->content)
                                            <a href="{{ route('admin.content.show', $content->id) }}" class="btn btn-info btn-sm mt-2" target="_blank">View Content</a>
                                        @endif
                                    </div>
