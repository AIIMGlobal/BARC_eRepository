                                            ...
                                            <div class="thumbnail-wrapper">
                                                ...
                                                <div class="overlay">
                                                    <div class="action-icons">
                                                        <i class="lar la-heart {{ $content->is_favorite ? 'active' : '' }}" data-id="{{ Crypt::encryptString($content->id) }}" onclick="toggleFavorite(this)"></i>

                                                        <i class="las la-bookmark {{ $content->is_saved ? 'active' : '' }}" data-id="{{ Crypt::encryptString($content->id) }}" onclick="toggleSave(this)"></i>
