...
@section('title', 'Edit Upazila | '.($global_setting->title ?? ""))
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-height-100">
                        <div class="card-header align-items-center d-flex">
                            <h4 class="card-title mb-0 flex-grow-1">Edit Upazila</h4>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xsm-12">
                                        <div>
                                            ...
                                            <input type="text" class="form-control" name="name_en" placeholder="{{ __('pages.Upazila Name') }}" value="{{ $upazila->name_en }}" required>
                                        </div>
                                    </div>
